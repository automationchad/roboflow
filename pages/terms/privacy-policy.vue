	...
	<div>
		...
		<div class="relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]">
			...
			<div class="px-4 sm:px-6 lg:px-8">
				<div class="relative mx-auto max-w-[37.5rem] pt-20 pb-24 text-center">
					...
					<p class="mt-4 text-base leading-7 text-slate-600">
						Last updated on {{ format(new Date(), 'MMMM dd, yyyy') }}
					</p>
				</div>
			</div>
			<div class="mx-auto mb-8 flex max-w-3xl justify-center">
				<button
					type="button"
					@click="print"
			...
			<div class="relative px-4 py-24 sm:px-6 lg:px-8">
				...
				>
					<p>
						This privacy policy ("Policy") describes how Motis Group Labs Inc.
						("Motis Group", "we", "us" or "our") collects, protects and uses the
						personally identifiable information ("Personal Information") you
						("User", "you" or "your") may provide through the Motis Group
						website (motis.group) or in the course of purchasing any Motis Group
						products (collectively, "Website"). The Policy also describes the
					...
					<p>
						...
						to login to the Website and access any purchased Motis Group
						products.
					</p>
					...
					<p>
						...
						party payment processor, Stripe (<a href="https://stripe.com"
							>stripe.com</a
						>). Stripe may ask you for personal and/or non-personal information,
						such as your name, address, email address, credit card information,
						or other Personal Information. Stripe has a privacy policy (<a
							href="https://stripe.com/privacy"
							>stripe.com/privacy</a
						>) that describes their collection and use of personal information.
						Motis Group does not control Stripe or its collection or use of
						information. Any questions or concerns about Stripe’s practices
						should be directed to Stripe.
					</p>
					<p>
						Stripe provides us with certain non-personal information relating to
						...
						Stripe does not supply us with any of your other Personal
					...
					<p>
						...
						the products you have purchased from Motis Group.
					</p>
					<p>
					...
					<p>
						...
						email at
						<a href="mailto:support@motis.group">support@motis.group</a>. These
					...
					<p>
						...
						are handled by Stripe and all such transactions, including any
						Personal Information or non-personal information collected by
						Stripe, are under the control of Stripe. We encourage purchasers to
						read Stripe’s Privacy Policy (<a href="https://stripe.com/privacy"
							>stripe.com/privacy</a
						>).
					</p>

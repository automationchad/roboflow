...
<template>
	<div>
		<div class="-mt-[5.75rem] overflow-hidden pb-20 sm:pb-24 lg:pb-32">
			<div class="relative bg-slate-50 pt-[5.75rem] pb-16">
				<img
					src=""
					alt=""
					class="absolute top-0 left-0 z-10 w-[90.4375rem] max-w-none"
				/>
				<div
					class="max-w-container relative z-20 mx-auto px-4 pt-14 sm:px-6 sm:pt-20 lg:px-8"
				>
					<div class="mx-auto max-w-[45rem] text-center">
						...
						<p
							class="mt-4 text-5xl font-extrabold leading-[3.5rem] tracking-tight text-slate-900"
						>
							Get everything, forever.
						</p>
						<p class="mt-4 text-lg text-slate-700">
							Get lifetime access to 500+ components and every template
							available today, plus any new content we add in the future for a
							simple one-time price.
						</p>
					</div>
				</div>
			</div>
			<div class="max-w-container mx-auto w-full px-4 sm:px-6 lg:px-8">
				<div
					class="mx-auto grid grid-cols-1 items-start gap-8 sm:max-w-lg lg:max-w-[63rem] lg:grid-cols-2"
				>
					<div class="">
						<div
							class="absolute bottom-[40%] -top-72 left-1/2 -ml-[55vw] w-[110vw] bg-slate-50 text-slate-600/10 lg:hidden"
						>
							<svg
								class="absolute inset-0 h-full w-full [mask-image:linear-gradient(to_top,white,transparent)]"
						...
						<div
							class="relative z-20 -mx-4 shadow-lg ring-1 ring-slate-900/10 sm:mx-0 sm:rounded-3xl"
						>
							<div
							...
							<div class="relative bg-white p-5 py-10 sm:rounded-3xl sm:px-10">
								<div class="flex">
									<svg
								...
								<div
									class="relative -mx-5 mt-8 ring-1 ring-slate-900/5 sm:mx-0 sm:rounded-2xl"
								>
									<div
										class="absolute -bottom-px left-1/2 -ml-48 flex h-[2px] w-96"
									>
									...
									<div
										class="relative flex flex-col bg-slate-50 py-8 px-5 sm:rounded-2xl"
									>
										...
										>
											<span class="hidden sm:inline">Unlimited requests.</span
											><span class="hidden sm:inline">Unlimited projects.</span
											><span class="hidden sm:inline">Cancel anytime.</span
											><span class="sm:hidden"
												>Includes unlimited requests and free updates.</span
											>
										</p>
										<button
											v-if="!user"
											@click="showLoginModal = true"
											class="mt-6 inline-flex w-full justify-center rounded-lg bg-slate-900 py-2 px-3 text-sm font-semibold text-white hover:bg-slate-700"
										>
					...
					<div class="relative">
						<div
							class="absolute bottom-14 -top-72 -left-[calc(1rem+55vw)] hidden w-[110vw] bg-slate-50 text-slate-600/10 lg:block"
						>
							<svg
								class="absolute inset-0 z-10 h-full w-full [mask-image:linear-gradient(to_top,white,transparent)]"
								xmlns="http://www.w3.org/2000/svg"
							>
								<defs>
									<pattern
						...
						<div
							class="relative z-10 -mx-4 bg-[radial-gradient(164.75%_100%_at_50%_0%,#334155_0%,#0F172A_48.73%)] py-10 px-5 shadow-lg sm:mx-0 sm:rounded-3xl sm:px-10"
						>
							<div class="flex">
								<svg
									class="h-14 w-14 flex-none"
							...
							<div
								class="relative -mx-5 mt-8 flex flex-col bg-slate-700/25 py-8 px-5 ring-1 ring-slate-700/50 sm:mx-0 sm:rounded-2xl"
							>
								<p class="flex items-center justify-center">
								...
								<p
									class="order-last -mx-1 mt-4 flex justify-center text-sm leading-6 text-slate-400 sm:space-x-2"
								>
									<span class="hidden sm:inline">Lifetime access.</span
									><span class="hidden sm:inline">Unlimited projects.</span
									><span class="hidden sm:inline">Free updates.</span
									><span class="sm:hidden"
										>Includes lifetime access and free updates.</span
									>
								</p>
								<a
									class="mt-6 inline-flex w-full justify-center rounded-lg bg-slate-600 py-2 px-3 text-sm font-semibold text-white hover:bg-slate-500"
									href="https://calendly.com/motis-group/all-access"
									><span>Get all-access for your team</span></a
								>
							</div>
							<div class="mt-8 flex">
								<svg
								...
								<div class="ml-6 text-sm leading-6 text-slate-400">
									<p>
										<strong class="font-semibold text-slate-100"
											>Get access for your entire team</strong
										>

<script setup>
	...
	const client = ref({ type: 'client', name: '' });
							...
							<div class="grid grid-cols-12 gap-4">
								...
								>
									<div class="space-y-2">
										...
										<p class="text-scale-1100 text-base">
											Start by creating a project and inserting information. Our
											AI assistants make collecting information a breeze, but
											there's also your personal Slack channel if you need
											something more.
										</p>
									</div>
									<div class="flex flex-wrap items-center gap-2">
										<NuxtLink :to="`/clients/${client.id}/projects`"
											><button

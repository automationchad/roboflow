							...
							<div class="my-6 space-y-8">
								<div class="mx-3">
									<div class="mb-2 flex space-x-3 px-3 font-normal">
										<span class="text-scale-900 w-full text-sm"></span>
									</div>
									<div>
										<a
											class="block"
											target="_self"
											href="/project/nsfipxnlucvgchlkqvqw/reports"
								...
								<div class="mx-3">
									...
									<div>
										<a
											class="block"
											target="_self"
											href="/project/nsfipxnlucvgchlkqvqw/reports/api-overview"
											><li role="menuitem" class="outline-none">
												<a
										...
										><a
											class="block"
											target="_self"
											href="/project/nsfipxnlucvgchlkqvqw/reports/database"
											><li role="menuitem" class="outline-none">
												<a
													class="ring-scale-1200 border-scale-500 group-hover:border-scale-900 group flex cursor-pointer items-center space-x-3 px-3 py-1 font-normal outline-none focus-visible:z-10 focus-visible:ring-1"
													><span
										...
										><a
											class="block"
											target="_self"
											href="/project/nsfipxnlucvgchlkqvqw/reports/query-performance"
											><li role="menuitem" class="outline-none">
												<a
													class="ring-scale-1200 border-scale-500 group-hover:border-scale-900 group flex cursor-pointer items-center space-x-3 px-3 py-1 font-normal outline-none focus-visible:z-10 focus-visible:ring-1"
													><span
														...
														>
															<div
																...
																class="flex w-full items-center gap-2 truncate"
															>
																<span class="truncate">Query Performance </span
																><span
																	class="truncate text-xs font-normal text-orange-800"
																	>NEW</span
																>

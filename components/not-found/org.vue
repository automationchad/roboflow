<template>
	<div
		class="grid h-screen min-h-full grid-cols-1 grid-rows-[1fr,auto,1fr] bg-white dark:bg-transparent lg:grid-cols-[max(50%,36rem),1fr]"
	>
		<header
		...
		>
			<div class="max-w-lg">
				...
				<p class="mt-6 text-base leading-7 text-gray-600 dark:text-slate-400">
					The organization you tried to access does not exist or you are not a
					part of it. Please make sure the link is correct and check with the
					organization owner that you have been given access.
				</p>
				<div class="mt-10">
					<a
						href="/"

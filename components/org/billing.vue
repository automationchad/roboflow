						...
						<div class="pb-6">
							...
							>
								<div class="w-full" v-if="!open">
									<div
										class="block rounded-md border-0 px-3 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-900 dark:bg-slate-800 dark:bg-slate-800 dark:text-white dark:ring-slate-700 sm:text-sm sm:leading-6"
									>
										{{ state.email }}
									</div>
								</div>

<template>
	<div class="fixed right-10 top-20 z-10">
		...
		>
			<div class="flex w-full justify-between space-x-4">
				...
				>
					<div class="relative flex items-center">
						<XCircleIcon class="z-10 h-7 w-7 text-red-400" /><span
			...
			<div
				class="absolute inset-x-0 bottom-0 h-0.5 rounded-r-full bg-gradient-to-r from-sky-400 to-purple-400 transition-width duration-75 ease-in"
				:style="`width: ${width}%`"
			></div>
		</div>
	</div>

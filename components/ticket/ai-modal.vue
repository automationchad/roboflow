		...
		<div class="space-y-3">
			<transition
				...
				><div
					...
					:class="[
						'ai_shadow shadow-inset w-full rounded-r-lg rounded-t-lg rounded-bl-sm bg-[#E6E5EB] px-4 py-3 text-sm leading-7 text-gray-200 shadow-[#9643FF]/25 ring-1 ring-inset ring-black/5 dark:prose-invert dark:bg-[#1C1B2C] dark:ring-white/5',
					]"
					id="ai-response"
				>
					<div class="flex items-start space-x-1">
						<img
							src="~/assets/images/tracy_ai_profile.png"
							alt="Tracy AI"
						...
						<div class="flex">
							<div class="flex items-center" v-if="loading && !writing">
								<svg
									...
									class="ml-1 mt-1 h-5 w-5 animate-spin"
									fill="none"
									viewBox="0 0 24 24"
								>
									<path
			...
			<div class="flex w-full">
				<Menu
					as="div"
					class="relative inline-block w-full bg-[#06051A]"
					v-slot="{ open }"
				>
					<div
						class="ai_shadow inline-flex w-full justify-start gap-x-1.5 rounded-md bg-white px-3 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-slate-800 dark:bg-white/5"
					>
						<div
						...
						>
							...
							<input
								...
								:class="[
									...
									'block w-full border-0  bg-transparent py-1.5 pr-4 font-normal text-white placeholder:font-normal visited:bg-transparent focus:border-0  focus:ring-0 active:bg-transparent sm:text-sm sm:leading-6',
								]"
								:placeholder="
									loading
										? 'AI is writing...'
										: aiResponse
										? 'Tell Tracy what to do next...'
										: 'Ask Tracy to write anything...'
								"
							/>
						...
						>
							<div class="py-1">
								<MenuItem v-slot="{ active }">
									...
									>
										<svg
											class="mr-3 h-5 w-5 text-white group-hover:text-gray-500 dark:group-hover:text-white"
											fill="none"
											viewBox="0 0 24 24"
										>
											<path

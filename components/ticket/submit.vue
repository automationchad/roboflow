			...
			>
				<div class="fixed inset-0 z-10 overflow-y-auto">
					...
					>
						...
						>
							<div
								class="relative transform overflow-hidden rounded-lg bg-white pb-4 text-left shadow-xl transition-all dark:bg-slate-800 sm:my-8 sm:w-full sm:max-w-3xl"
							>
								<div class="relative w-full flex-1 overflow-y-auto">
									<div class="bg-slate-50 px-8 py-6 sm:px-10">
										<div class="flex items-center justify-between">
											<div
												class="flex items-center text-lg leading-6 text-gray-900"
											>
												<img
								...
								>
										...
										<div class="grid grid-cols-1 gap-x-8 sm:grid-cols-2">
												...
												<div class="sm:col-span-2">
													<Listbox as="div" v-model="selectedTicket">
														...
														<div class="relative mt-2">
															...
															>
																<span
																	class="inline-flex w-full truncate text-black"
																>
																	<span class="truncate">{{
													...
													>
														<div class="flex w-full justify-between">
															<div class="flex items-center text-sm">
																...
																Expected response times are based on your plan's
																tier
															</div>
															<DisclosureButton
														...
														<transition
															...
															>
																Free tier support is available within the
																community and officially by the team on a best
																efforts basis, though we cannot guarantee a
																response time. For a guaranteed response time we
																recommend upgrading to the Pro tier. Enhanced
																SLAs for support are available on our Enterprise
																Tier.
											...
											<div class="col-span-2 space-y-6 px-10">
												...
												<div class="sm:col-span-2">
													...
													>
														Please add a message about the issue that you're
														facing
													</p>
												</div>
												<div class="sm:col-span-2">
									...
									<div
										class="flex-shrink-0 border-t border-gray-200 px-10 py-5"
									>
